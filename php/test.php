...
print_r($multiarr);echo '<br />';
var_dump($multiarr);echo '<br /><br />';
...
var_dump($customer);echo '<br />';

$properOrderedArray = array_merge(array_flip(array('name', 'dob', 'address')), $customer);
var_dump($properOrderedArray);echo '<br />';
...
print_r($customer2);echo '<br />';

$properOrderedArray = array_merge(array_flip(array('name-1222', 'dob-2333', 'address-1000')), $customer2);
print_r($properOrderedArray);echo '<br />';

$properOrderedArray2 = array_replace(array_flip(array('name-1222', 'dob-2333', 'address-1000')), $customer2);
print_r($properOrderedArray2);echo '<br /><br />';

//test array_slice
$a=array("a"=>"red","b"=>"green","c"=>"blue","d"=>"yellow","e"=>"brown");
print_r($a);echo '<br />';
print_r(array_slice($properOrderedArray,0,2));echo '<br />';

$a=array("0"=>"red","1"=>"green","2"=>"blue","3"=>"yellow","4"=>"brown");
print_r($a);echo '<br />';
print_r(array_slice($properOrderedArray2,1,2,true));echo '<br /><br />';